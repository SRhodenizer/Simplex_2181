...
void Application::Display(void)
{
	...
	//removed gimbal lock by editing the key pressed X,Y,Z code in AppClassControls.cpp
	m_qOrientation = m_qOrientation * glm::angleAxis(glm::radians(1.0f), vector3(0,0,0));
